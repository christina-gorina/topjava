...
INSERT INTO meals (date_time, description, calories, user_id) VALUES
    (make_timestamp(2020, 6, 22, 8, 15, 0),'Завтрак пользователя', 600, 100000),
    (make_timestamp(2020, 6, 22, 15, 20, 0),'Обед пользователя', 700, 100000),
    (make_timestamp(2020, 6, 22, 21, 10, 0),'Ужин пользователя', 300, 100000),
