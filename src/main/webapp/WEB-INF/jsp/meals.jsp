                    ...
                    <form id="filter" method="get" action="meals/filter">
                        <div class="row">
                            <div class="offset-1 col-2">
                                ...
                                <input id="startDate" autocomplete="off" class="form-control" type="date"
                            ...
                            <div class="offset-1 col-2">
                                ...
                                <input class="form-control" type="time" name="startTime" id="startTime"
                                       autocomplete="off" value="${param.startTime}">
                            </div>
                            <div class="col-2">
                ...
                <div class="modal-body">
                    <form id="detailsForm">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" id="dateTime" name="dateTime" autocomplete="off" placeholder="<spring:message code="meal.dateTime"/>">
                        </div>
